      ...
      >
          ...
          <View style={styles.card}>
            ...
            <View style={styles.toggleRow}>
              ...
              <TouchableOpacity
                style={[
                  styles.toggleButton,
                  settings.distanceUnit === 'miles' && styles.toggleButtonActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.toggleButtonText,
                    settings.distanceUnit === 'miles' && styles.toggleButtonTextActive,
                  ]}
                >
                  mi
                </Text>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.toggleRow}>
              <TouchableOpacity
                style={[
                  styles.toggleButton,
                  settings.tempUnit === 'celsius' && styles.toggleButtonActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.toggleButtonText,
                    settings.tempUnit === 'celsius' && styles.toggleButtonTextActive,
                  ]}
                >
                  °C
                </Text>
              ...
              <TouchableOpacity
                style={[
                  styles.toggleButton,
                  settings.tempUnit === 'fahrenheit' && styles.toggleButtonActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.toggleButtonText,
                    settings.tempUnit === 'fahrenheit' && styles.toggleButtonTextActive,
                  ]}
                >
                  °F
                </Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.resetHint}>
            You will see the welcome screens again on next app launch.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
