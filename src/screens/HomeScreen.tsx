...
import { calculateMarsDistance, formatLightTime } from '../utils/marsDistance';
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <LinearGradient colors={['#2A0800', '#5C1A00', '#E8532A', '#C1440E']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.hero}>
          <View style={styles.heroOverlay}>
            <Text style={styles.heroEyebrow}>EDUCATIONAL APP</Text>
            <Text style={styles.heroTitle}>Road to Mars</Text>
            <Text style={styles.heroSubtitle}>How humanity will reach the Red Planet</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.distanceCard}>
            <LinearGradient colors={[theme.colors.accentDim, '#1A0A05']} style={styles.distanceGradient}>
              ...
              <View style={styles.distanceMeta}>
                ...
                <View style={styles.distanceMetaItem}>
                  ...
                  <Text style={styles.distanceMetaValue}>{distanceData.distanceAU.toFixed(3)} AU</Text>
                </View>
              </View>
            </LinearGradient>
          </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.statsGrid}><StatBadge icon="📏" label="Avg Distance" value="225M km" /><StatBadge icon="⏱️" label="Travel Time" value="~7 mo" /></View>
          <View style={[styles.statsGrid, { marginTop: theme.spacing.sm }]}><StatBadge icon="⚖️" label="Gravity" value="38%" /><StatBadge icon="🌡️" label="Avg Temp" value="−60°C" /></View>
          <View style={[styles.statsGrid, { marginTop: theme.spacing.sm }]}><StatBadge icon="📅" label="Mars Day" value="24h 37m" /><StatBadge icon="🪐" label="Mars Year" value="687 days" /></View>
        </View>

        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Next Launch Window</Text>
          <View style={styles.launchCard}>
            <View style={styles.launchLeft}><Text style={styles.launchIcon}>🪟</Text></View>
            <View style={styles.launchRight}>
              <Text style={styles.launchDate}>Late 2026</Text>
              <Text style={styles.launchDesc}>Earth and Mars align every 26 months for the most fuel-efficient trajectory. The next window opens approximately December 2026.</Text>
              <View style={styles.launchBadge}><Text style={styles.launchBadgeText}>~7 months away</Text></View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <View style={styles.featuredBadge}><Text style={styles.featuredBadgeText}>SPOTLIGHT</Text></View>
          </View>
          <TouchableOpacity style={styles.featuredCard} activeOpacity={0.85}>
            <LinearGradient colors={['#1A0800', theme.colors.accentDim]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.featuredGradient}>
              <View style={styles.featuredHeader}>
                <Text style={styles.featuredIcon}>🚀</Text>
                <View>
                  <Text style={styles.featuredName}>{FEATURED_MISSION.name}</Text>
                  <Text style={styles.featuredAgency}>{FEATURED_MISSION.agency} · {FEATURED_MISSION.year}</Text>
                </View>
                <View style={styles.plannedBadge}><Text style={styles.plannedBadgeText}>PLANNED</Text></View>
              </View>
              <Text style={styles.featuredDesc} numberOfLines={3}>{FEATURED_MISSION.description}</Text>
              <View style={styles.featuredHighlights}>
                {FEATURED_MISSION.highlights.slice(0, 2).map((h, i) => (<Text key={i} style={styles.featuredHighlight}>▸ {h}</Text>))}
              </View>
            </LinearGradient>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.quickFacts}>
            <View style={styles.quickFact}>
              ...
              <Text style={styles.quickFactText}>Olympus Mons on Mars is the tallest volcano in the solar system at <Text style={styles.highlight}>21.9 km</Text> — nearly 3× Mount Everest.</Text>
            </View>
            <View style={styles.divider} />
            <View style={styles.quickFact}>
              <Text style={styles.quickFactIcon}>🏔️</Text>
              <Text style={styles.quickFactText}>Valles Marineris is a canyon <Text style={styles.highlight}>4,000 km long</Text> — wide enough to cross the entire United States.</Text>
            </View>
            <View style={styles.divider} />
            <View style={styles.quickFact}>
              <Text style={styles.quickFactIcon}>💧</Text>
              <Text style={styles.quickFactText}>Mars has enough polar water ice that if melted, it would cover the planet in <Text style={styles.highlight}>35 meters</Text> of water.</Text>
            </View>
          </View>
        </View>
      </ScrollView>
