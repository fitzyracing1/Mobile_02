          ...
          <View style={styles.launchCard}>
            ...
            <View style={styles.launchRight}>
              ...
              <Text style={styles.launchDesc}>
                Earth and Mars align every 26 months for the most fuel-efficient
                trajectory. The next window opens approximately December 2026.
              </Text>
              <View style={styles.launchBadge}>
                <Text style={styles.launchBadgeText}>~7 months away</Text>
              </View>
            </View>
          </View>
        </View>
