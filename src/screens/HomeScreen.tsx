      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <LinearGradient colors={['#2A0800', '#5C1A00', '#E8532A', '#C1440E']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.hero}>
          <View style={styles.heroOverlay}>
            ...
            <TouchableOpacity style={styles.settingsButton} onPress={() => navigation.navigate('Settings')} hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}>
        ...
        <View style={styles.section}><LaunchCountdown /></View>
        <View style={styles.section}><LiveOnMars /></View>
            ...
            <LinearGradient colors={['#1A0800', theme.colors.accentDim]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.featuredGradient}>
              ...
              <View style={styles.featuredHighlights}>
                {FEATURED_MISSION.highlights.slice(0, 2).map((h, i) => (
                  <Text key={i} style={styles.featuredHighlight}>▸ {h}</Text>
                ))}
              </View>
            </LinearGradient>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  settingsButton: { position: 'absolute', top: 12, right: 16 },
