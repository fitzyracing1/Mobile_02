      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.quickFacts}>
            <View style={styles.quickFact}><Text style={styles.quickFactIcon}>🌋</Text><Text style={styles.quickFactText}>Olympus Mons on Mars is the tallest volcano in the solar system at <Text style={styles.highlight}>21.9 km</Text> — nearly 3× Mount Everest.</Text></View>
            <View style={styles.divider} />
            <View style={styles.quickFact}><Text style={styles.quickFactIcon}>🏔️</Text><Text style={styles.quickFactText}>Valles Marineris is a canyon <Text style={styles.highlight}>4,000 km long</Text> — wide enough to cross the entire United States.</Text></View>
            <View style={styles.divider} />
            <View style={styles.quickFact}><Text style={styles.quickFactIcon}>💧</Text><Text style={styles.quickFactText}>Mars has enough polar water ice that if melted, it would cover the planet in <Text style={styles.highlight}>35 meters</Text> of water.</Text></View>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
